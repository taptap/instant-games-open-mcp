## <small>1.24.4 (2026-05-29)</small>

* feat(maker): add install shortcut alias ([d898367](https://github.com/taptap/instant-games-open-mcp/commit/d898367))
...
* ci(maker): add npm token publish fallback ([5a3cedb](https://github.com/taptap/instant-games-open-mcp/commit/5a3cedb))
...
* ci(maker): set npm publish environment ([2516738](https://github.com/taptap/instant-games-open-mcp/commit/2516738)), closes [#214](https://github.com/taptap/instant-games-open-mcp/issues/214)

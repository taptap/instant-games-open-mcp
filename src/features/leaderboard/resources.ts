 ...
 */
export const leaderboardResourceDefinitions: ResourceDef[] = [
  // API Documentation
  {
...
/**
 * Resource Handlers (must match order of definitions above)
 */
export const leaderboardResourceHandlers = [
  // docs://leaderboard/api/get-manager
  async () => leaderboardTools.getLeaderboardManager(),

  // docs://leaderboard/api/open
  async () => leaderboardTools.openLeaderboard(),

  // docs://leaderboard/api/submit-scores
  async () => leaderboardTools.submitScores(),

  // docs://leaderboard/api/load-scores
  async () => leaderboardTools.loadLeaderboardScores(),

  // docs://leaderboard/api/load-player-score
  async () => leaderboardTools.loadCurrentPlayerScore(),

  // docs://leaderboard/api/load-centered-scores
  async () => leaderboardTools.loadPlayerCenteredScores(),

  // docs://leaderboard/overview
  async () => leaderboardTools.getLeaderboardOverview()
];

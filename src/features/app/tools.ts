...
export const appTools: ToolRegistration[] = [
  ...
  // 📱 Check Environment
  {
    definition: {
      ...
      description:
        'Check local runtime configuration and user authentication status. Use this to verify signer mode, TAPTAP_MCP_MAC_TOKEN, and TAPTAP_MCP_CLIENT_ID configuration.',
      inputSchema: {
        type: 'object',
        properties: {},
      },
